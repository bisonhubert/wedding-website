function initMap() {
  var t = { lat: 38.047521, lng: -122.1354908 },
  ...
  for (
    y = (function(t) {
      for (
        ...
        (i = (s % 4) * 8),
          (r[(e = (s - (s % 4)) / 4)] = r[e] | (t.charCodeAt(s) << i)),
          s++;
      return (
        (e = (s - (s % 4)) / 4),
        (i = (s % 4) * 8),
